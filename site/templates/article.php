...
<script type="application/ld+json">
{
  ...
  "image": {
    "@type": "ImageObject",
    "url": "<?= $page->facebookImage()->toFile()->url() ?>",
    "height": 2800,
    "width": 2000
  },
  ...
  "author": {
   ...
   "publisher": {
    ...
    "logo": {
      "@type": "ImageObject",
      "url": "https://a-web-strategy.co.uk/assets/images/a-web-strategy-social-web.png"
    }
  },
    ...
    <article itemscope itemtype="http://schema.org/Article" class="article single wrap">
      ...
      <div class="overlay"></div>
        <div class="wrapper">
          <div class="banner-content">
            <h1 itemprop="headline" class="intro-large"><?= $page->title()->html() ?></h1>
          </div>
        </div>
      </div>
      ...
      <section class="content-section article-section">
        ...
        <div class="intro text">
          ...
          <span style="visibility:hidden;font-size:0;" itemprop="publisher" itemscope itemtype="https://schema.org/Organization">
            <meta itemprop="name" content="A Web Strategy">
            <div itemprop="logo" itemscope itemtype="http://schema.org/ImageObject">
              <img itemprop="url" src="https://a-web-strategy.co.uk/assets/images/a-web-strategy-social-web.png" style="display:none" />
            </div>
          </span>

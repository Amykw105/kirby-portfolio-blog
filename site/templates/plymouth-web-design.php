<?php snippet('header') ?>
  ...
  <main class="main" role="main">
    ...
    <section class="client-showcase">
      <div class="wrapper">
          <p class="page-title">Featured Plymouth Client</p>
          <img src="/content/2-clients/4-amys-hair-beauty-web-design-plymouth/amys-hair-and-beauty-web-design-plymouth.png" alt="Amy's Hair & Beauty Web Design"/>
          <p class="showcase-copy">Amy's Hair & Beauty<br/>
          <span>Integrated Facebook Feed<br/></span>
          Bespoke Design & Development<br/>
        <a href="/clients/amys-hair-beauty-web-design-plymouth">View case study</a></p>
